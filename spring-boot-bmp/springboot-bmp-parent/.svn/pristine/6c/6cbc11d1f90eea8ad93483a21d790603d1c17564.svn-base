...
public class BranchBo implements Serializable {
	...
	/* 子机构 */
	private List<BranchBo> children;
	/* 作业中心标示 */
	 ...
	 * @return the children
	 */
	public List<BranchBo> getChildren() {
		return children;
	}
	 ...
	 *            the children to set
	 */
	public void setChildren(List<BranchBo> children) {
